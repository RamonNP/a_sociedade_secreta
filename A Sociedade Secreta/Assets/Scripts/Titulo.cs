	...
	private void DefinirEventos ()
	{
		...
		if (btnNovoSlot1 != null && btnNovoSlot2 != null && btnNovoSlot3 != null)
		{
			btnNovoSlot1.onClick.AddListener (delegate 
			{
				...
				Fade fade = FindObjectOfType(typeof(Fade) ) as Fade;
        		fade.fadeIn();
        		audioController.trocarMusica(audioController.musicaFase1, "historiaCena1", true);
		...
		*/
		...
		if (volumeMusicaSlider != null && volumeEfeitosSlider != null)
		{
			...
			volumeEfeitosSlider.value = audioController.volumeMaximoFx;
			...
			volumeMusicaSlider.onValueChanged.AddListener (delegate
			{
				...
				audioController.sMusic.volume = volumeTemporario;
			...
			volumeEfeitosSlider.onValueChanged.AddListener (delegate
			{
				...
				audioController.volumeMaximoFx = volumeTemporario;
